import React,{act, useCallback, useReducer,useContext} from "react";
import './NewPlace.css';
...
const NewPlace = () => {
    ...
    <form className="place-form" onSubmit={placeSubmitHandler}>
        ...
        <Input id="description" element="textarea" label="Description" validators={[VALIDATOR_MINLENGTH(5)]} errorText="Please enter a valid description(atleast 5 characters)." onInput={inputHandler} />
